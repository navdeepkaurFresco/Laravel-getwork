            ...
            ************************************/
            ...
            var topCategoryChartOptions = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['Introduction to Banking', 'Role of RBI, Banking Accounting', 'AML & KYC, CFT ', 'Cash Operations ', 'NI Act & Cheques, Clearing Functions Fund Transfer'],
                    textStyle: {
                        color: '#FFF'
                    },
                },
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: 335, name: 'Introduction to Banking1 '},
                            {value: 618, name: 'Role of RBI'},
                            {value: 234, name: 'AML & KYC, CFT'},
                            {value: 135, name: 'Cash Operations'},
                            {value: 956, name: 'NI Act & Cheques, Clearing Functions Fund Transfer'}
                        ]
                    }
                ]
            };
